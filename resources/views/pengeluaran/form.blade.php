            ...
            <form class="form-horizontal" data-toggle="validator" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="jenis_pengeluaran" class="col-md-3 control-label">Jenis Pengeluaran</label>
                        <div class="col-md-6">
                            <input type="text" name="jenis" id="jenis" class="form-control" autofocus required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="number" name="nominal" id="nominal" class="form-control" autofocus required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
